...
function updateFormable() {
    ...
    if (!isEmpty(name) && !isEmpty(canform) && !isEmpty(required) && !isEmpty(buttonName) && !isEmpty(buttonDesc)) {
        ...
        if (!isAlertVisible) output.innerHTML = output.innerHTML.replace(output.innerHTML.substring(output.innerHTML.indexOf("<br><br>&nbsp;&nbsp;&nbsp;&nbsp;CustomAlert"), output.innerHTML.indexOf("<br>&nbsp;&nbsp;&nbsp;&nbsp;},<br>},") + 30), "");
